...
function send(link) {
    ...
    req.open("GET", `${server}send/${link}`, true);
    req.send(true);
...
function refresh() {
    ...
    req.onload = function() {
        ...
        if (data.length == 0) {
            ...
            "7_on", "8_on", "9_on", "10_on", "11_o", "12_o", "13_o", "ch1", "ch2", "ch3"]
            off_arr = ["0_off", "1_off", "2_off", "3_off", "4_off", "5_off", "6_off",
            "7_off", "8_off", "9_off", "10_off", "11_c", "12_c", "13_c", "co1", "co2", "co3"]
            obj_arr = [obj.L0, obj.L1, obj.L2, obj.L3, obj.L4, obj.L5, obj.L6, obj.L7,
            obj.L8, obj.L9, obj.L10, obj.L11, obj.L12, obj.L13, obj.ch1, obj.ch2, obj.ch3]
